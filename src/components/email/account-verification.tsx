...
import { EMAIL_VERIFICATION_EXPIRES_IN_MINUTES } from '#/lib/const'
import {
  Body,
  Container,
  Head,
      ...
      <Html lang="fa-IR" dir="rtl">
        ...
        <Body className="bg-gray-100 text-right font-sans" dir="rtl">
          <Container className="mt-16 rounded-xl border border-gray-300 bg-white p-4 px-8">
            ...
            <Text>
              لینک مورد نظر فقط تا {EMAIL_VERIFICATION_EXPIRES_IN_MINUTES} دقیقه
              ی دیگر قابل استفاده خواهد بود.
            </Text>
            <Hr />
